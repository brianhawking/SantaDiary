...
class App {
    ...
    static let avatars = ["activity_american-football", "activity_art", "activity_baseball", "activity_basketball", "activity_soccer-player", "activity_guitar", "activity_music-notes", "activity_piano", "activity_run", "activity_tennis-racket", "animal_anglerfish", "animal_butterfly", "animal_chameleon", "animal_dog", "animal_Dog-1", "animal_dolphin", "animal_eagle", "animal_frog", "animal_giraffe", "animal_horse", "animal_hummingbird", "animal_koala", "animal_ladybug-1", "animal_owl", "animal_seahorse", "animal_shark", "animal_sloth", "animal_wolf", "animal_dragon",  "dino_TRex", "animal_Bee", "dino_Ankylosaurus","dino_Styracosaurus", "dino_ampelosaurus", "dino_beipiaosaurus", "dino_edmontosaurus", "dino_parasaurolophus", "dino_scelidosaurus", "dino_styracosaurus-1", "dino_triceratops", "dino_volcano", "Footprint", "Pick", "SportsCar", "outdoor_Sunflower", "flower", "outdoor_rainbow", "outdoor_sunflower-1", "outdoor_tree", "food_HotDog", "food_ice-cream", "food_pizza"]
